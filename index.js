...
let phoneNumber = global.PAIRING_NUMBER || process.env.PAIRING_NUMBER || "254799963583";
let owner = JSON.parse(fs.readFileSync('./data/owner.json'));

global.botname = process.env.BOT_NAME || "TEDDY-XMD";
global.themeemoji = "•";
    ...
    try {
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (!!global.phoneNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 254700000000 (without + or spaces) : `)));
            } else {
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection == "open") {
                ...
                console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: Teddytech4`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: Teddytech1`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: Teddy Tech`));
